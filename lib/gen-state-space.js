...
StateSpace.prototype.getHairyProjection = function (stateId) {
    return this.hairyProjection[stateId];
};
...
StateSpace.prototype.addStateOver = function (base, state) {
    ...
    this.hairyProjection[state] = this.alphabet[Math.floor(Math.random()*this.alphabet.length)];
